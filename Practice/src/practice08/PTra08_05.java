...
public class PTra08_05 {
	 ...
	 */
	public static double quadrangle(double width, double heigh) {
		double answer= (heigh* width);
		return answer;
	}
	 ...
	 */
	public static double triangle(double width, double heigh) {
		double answer= (heigh* width/ 2);
		return answer;
	}
}
